...
import TabardQuoteFlow from "@/components/sections/TabardQuoteFlow";
import BrandingPricingTable from "@/components/ui/BrandingPricingTable";

export const metadata: Metadata = {
  title: "Workwear Tabard | Elevate Workwear Solutions",
  description:
    "Lightweight workwear tabard with adjustable side ties and embroidered or printed branding. One size, unisex. Available for bulk B2B orders.",
};

const SPECS = [
  { label: "Product Code", value: "ELV-010" },
  { label: "Style",        value: "Workwear Tabard" },
  { label: "Colour",       value: "Black" },
  { label: "Fabric",       value: "Lightweight Polyester" },
  { label: "Closure",      value: "Adjustable Side Ties" },
...
const FEATURES = [
  { text: "Lightweight, quick to put on over any uniform" },
  { text: "Adjustable side ties for a comfortable, secure fit" },
  { text: "Wide scoop neck for easy on and off" },
  { text: "Embroidered or printed branding for your business" },
  { text: "One size — fits most, unisex" },
  { text: "Ideal for cleaning, catering and food service teams" },
  { text: "Also available made to order in other colours and fabrics" },
];
...
export default function TabardPage() {
  const CRUMBS = [
    { label: "Home", href: "/" },
    { label: "Products", href: "/products" },
    { label: "Hospitality Wear", href: "/products#hospitality" },
    { label: "Workwear Tabard" },
  ];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[60%_40%] gap-0 lg:gap-10 items-start">
          ...
          <div className="flex flex-col gap-10">
            <div className="relative w-full lg:sticky" style={{ top: "88px", width: "100%", maxWidth: "min(460px, calc(65vh * 1200 / 1400))", margin: "0 auto" }}>
              ...
              <div className="absolute inset-0 overflow-hidden flex items-center justify-center" style={{ background: "#0A0A0E", border: "1px solid rgba(255,255,255,0.06)" }}>
                ...
                <Image src="/products/tabard/tabard-000.png" alt="Workwear Tabard" width={1024} height={1536}
                  className="relative z-10"
                  style={{ width: "88%", height: "88%", objectFit: "contain", filter: "brightness(1.05)" }}
          ...
          <div className="py-6 lg:py-2 flex flex-col gap-8">
            ...
            <p style={{ fontFamily: "var(--font-dm-sans,sans-serif)", fontSize: "clamp(0.85rem,1.2vw,0.95rem)", color: "rgba(255,255,255,0.45)", lineHeight: 1.8 }}>
              A lightweight tabard built for teams who need to cover up quickly between jobs.
              The wide neck and adjustable side ties make it fast to put on and take off, while
              the simple silhouette layers over any uniform. Fully customisable with your
            ...
            <div className="h-[1px] w-full" style={{ background: "rgba(255,255,255,0.06)" }} />
            <TabardQuoteFlow productName="Workwear Tabard" />
