...
import BeanieViewer360 from "@/components/ui/BeanieViewer360";
import BeanieQuoteFlow from "@/components/sections/BeanieQuoteFlow";
import BrandingPricingTable from "@/components/ui/BrandingPricingTable";

export const metadata: Metadata = {
  title: "Premium Workwear Beanie | Elevate Workwear Solutions",
  description:
    "Premium ribbed-cuff workwear beanie with embroidered branding. One size fits most, unisex. Available for bulk B2B orders.",
};

const SPECS = [
  { label: "Product Code",  value: "ELV-003"                    },
  ...
  { label: "Cuff",          value: "Wide Ribbed Fold-Up Cuff"   },
  { label: "Industry",      value: "Workwear"                   },
];

const FEATURES = [
  { text: "Wide ribbed fold-up cuff for a premium fitted look"    },
  { text: "Large branded logo on the front cuff"                  },
  { text: "Soft acrylic knit for all-day comfort and warmth"      },
  { text: "One size fits most — suitable for all head sizes"      },
...
export default function BeanieDetailPage() {
  return (
      ...
      <div className="max-w-[1400px] mx-auto px-6 md:px-12 pt-28 pb-0">
        <nav className="flex items-center gap-2" aria-label="Breadcrumb">
          {[
            ...
            { label: "Caps & Beanies", href: "/products#caps-beanies"     },
            { label: "Premium Workwear Beanie", href: ""                  },
          ].map((crumb, i, arr) => (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[60%_40%] gap-0 lg:gap-10 items-start">
          ...
          <div className="flex flex-col gap-10">
            <div
              ...
              style={{ top: "88px", aspectRatio: "1200/1400", maxHeight: "90vh", width: "100%" }}
            >
              <BeanieViewer360 />
            </div>
          ...
          <div className="py-6 lg:py-2 flex flex-col gap-8">
            ...
            <div>
              ...
              <p style={{
                ...
                Ribbed Cuff · Acrylic Knit · One Size
              </p>
            </div>
            ...
            <p style={{
              ...
              A premium workwear beanie built for teams that need branded winter headwear
              that looks sharp and lasts. Constructed from soft acrylic knit with a wide
              ribbed fold-up cuff, ideal for embroidered branding. One size fits most —
              practical, professional, and fully customisable.
            </p>
            ...
            <div className="h-[1px] w-full" style={{ background: "rgba(255,255,255,0.06)" }} />
            <BeanieQuoteFlow productName="Premium Workwear Beanie" />
