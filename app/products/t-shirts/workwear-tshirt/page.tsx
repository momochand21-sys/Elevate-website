      ...
      <div className="max-w-[1400px] mx-auto px-6 md:px-12 py-10">
        <div className="grid grid-cols-1 lg:grid-cols-[60%_40%] gap-0 lg:gap-10 items-start">
          ...
          <div className="flex flex-col gap-10">
            <div className="relative w-full lg:sticky overflow-hidden" style={{ top: "88px", aspectRatio: "891/1024", maxHeight: "90vh", width: "100%", background: "#0A0A0E", border: "1px solid rgba(255,255,255,0.06)" }}>
              {/* subtle glow */}
