...
import PoloViewer360 from "@/components/ui/PoloViewer360";
import PoloQuoteFlow from "@/components/sections/PoloQuoteFlow";
import BrandingPricingTable from "@/components/ui/BrandingPricingTable";

export const metadata: Metadata = {
  title: "Premium Workwear Polo | Elevate Workwear Solutions",
  description:
    "220 GSM poly/cotton piqué polo with embroidered or printed branding. Regular UK fit, unisex. Available for bulk B2B orders.",
};

const SPECS = [
  { label: "Product Code",  value: "ELV-002"                     },
  { label: "Material",      value: "65% Polyester / 35% Cotton Piqué" },
  { label: "Weight",        value: "222 GSM"                      },
  { label: "Fit",           value: "Regular UK Fit"               },
  { label: "Gender",        value: "Unisex"                       },
  { label: "Branding",      value: "Embroidery or Print"          },
  { label: "Collar",        value: "Structured Polo Collar"       },
  { label: "Industry",      value: "Workwear"                     },
];

const FEATURES = [
  { text: "Structured polo collar for a professional appearance" },
  { text: "Large branded back logo for maximum visibility"       },
  { text: "Polo piqué fabric for breathability and comfort"      },
  { text: "Three-button placket with clean finish"               },
      ...
      <div className="max-w-[1400px] mx-auto px-6 md:px-12 pt-28 pb-0">
        <nav className="flex items-center gap-2" aria-label="Breadcrumb">
          {[
            ...
            { label: "Polo Shirts",   href: "/products#polo-shirts"  },
            { label: "Premium Workwear Polo", href: ""              },
          ].map((crumb, i, arr) => (
          ...
          <div className="py-6 lg:py-2 flex flex-col gap-8">
            ...
            <div>
              ...
              <p style={{
                ...
                222 GSM · Poly/Cotton Piqué · Professional
              </p>
            </div>
            ...
            <p style={{
              ...
              Engineered for businesses that require a smart professional appearance
              while maintaining comfort and durability. Constructed from premium
              poly/cotton piqué fabric for long-lasting wear, colour retention and
              everyday performance. Suitable for embroidery and print branding.
            </p>
            ...
            <div className="h-[1px] w-full" style={{ background: "rgba(255,255,255,0.06)" }} />
            <PoloQuoteFlow productName="Premium Workwear Polo" />
