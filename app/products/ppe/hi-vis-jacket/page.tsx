...
import HiVisViewer360 from "@/components/ui/HiVisViewer360";
import HiVisJacketQuoteFlow from "@/components/sections/HiVisJacketQuoteFlow";
import BrandingPricingTable from "@/components/ui/BrandingPricingTable";

export const metadata: Metadata = {
  title: "Hi-Vis Padded Jacket | Elevate Workwear Solutions",
  description:
    "High-visibility padded workwear jacket with reflective tape and embroidered or printed branding. Regular UK fit, unisex. Available for bulk B2B orders.",
};

const SPECS = [
  { label: "Product Code", value: "ELV-007" },
  { label: "Style",        value: "Hi-Vis Padded Jacket" },
  { label: "Colour",       value: "Hi-Vis Yellow" },
  { label: "Standard",     value: "Reflective Tape" },
  { label: "Shell",        value: "100% Polyester" },
  { label: "Fill",         value: "Padded Insulation" },
...
const FEATURES = [
  ...
  { text: "Reflective tape to front, back and arms" },
  { text: "Padded insulation for warmth in cold conditions" },
  { text: "Full-length zip with protective inner storm flap" },
  { text: "Zipped lower pockets for secure storage" },
...
export default function HiVisJacketPage() {
  const CRUMBS = [
    { label: "Home", href: "/" },
    { label: "Products", href: "/products" },
    { label: "PPE & Safety Wear", href: "/products#ppe" },
    { label: "Hi-Vis Padded Jacket" },
  ];
          ...
          <div className="py-6 lg:py-2 flex flex-col gap-8">
            <div>
              ...
              <p style={{ fontFamily: "var(--font-jetbrains,monospace)", fontSize: "0.62rem", letterSpacing: "0.12em", textTransform: "uppercase", color: "rgba(255,255,255,0.3)" }}>
                Hi-Vis Yellow · Reflective · Padded
              </p>
            </div>
            ...
            <p style={{ fontFamily: "var(--font-dm-sans,sans-serif)", fontSize: "clamp(0.85rem,1.2vw,0.95rem)", color: "rgba(255,255,255,0.45)", lineHeight: 1.8 }}>
              A high-visibility padded jacket built to keep your team safe and seen on site.
              Reflective tape to the front, back and arms meets high-vis requirements, while the
              padded shell provides warmth through the working day. Fully customisable with your
            ...
            <div className="h-[1px] w-full" style={{ background: "rgba(255,255,255,0.06)" }} />
            <HiVisJacketQuoteFlow productName="Hi-Vis Padded Jacket" />
