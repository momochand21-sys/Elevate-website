...
import HiVisVestQuoteFlow from "@/components/sections/HiVisVestQuoteFlow";
import BrandingPricingTable from "@/components/ui/BrandingPricingTable";

export const metadata: Metadata = {
  title: "Hi-Vis Safety Vest | Elevate Workwear Solutions",
  description:
    "Lightweight high-visibility safety vest with reflective tape and embroidered or printed branding. Regular UK fit, unisex. Available for bulk B2B orders.",
};
...
const FEATURES = [
  ...
  { text: "Velcro front closure for quick on and off" },
      ...
      <div className="max-w-[1400px] mx-auto px-6 md:px-12 py-10">
        <div className="grid grid-cols-1 lg:grid-cols-[60%_40%] gap-0 lg:gap-10 items-start">
          ...
          <div className="py-6 lg:py-2 flex flex-col gap-8">
            ...
            <div className="h-[1px] w-full" style={{ background: "rgba(255,255,255,0.06)" }} />
            <HiVisVestQuoteFlow productName="Hi-Vis Safety Vest" />
