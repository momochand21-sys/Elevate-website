...
/* ─── 12-frame sequence, 30° steps ─── */
const FRAMES = [
  "/products/polo-360/polo-000.png",
  "/products/polo-360/polo-030.png",
  "/products/polo-360/polo-060.png",
  "/products/polo-360/polo-090.png",
  "/products/polo-360/polo-120.png",
  "/products/polo-360/polo-150.png",
  "/products/polo-360/polo-180.png",
  "/products/polo-360/polo-210.png",
  "/products/polo-360/polo-240.png",
  "/products/polo-360/polo-270.png",
  "/products/polo-360/polo-300.png",
  "/products/polo-360/polo-330.png",
] as const;
...
export default function PoloViewer360() {
  ...
  return (
    ...
    >
      {/* Subtle atmospheric glow — keeps hoodie feeling lit */}
      <div className="absolute inset-0 pointer-events-none" style={{
        background:
          "radial-gradient(ellipse 55% 60% at 50% 44%, rgba(0,30,100,0.07) 0%, transparent 70%)",
      }} />
      ...
      >
        ...
        <div aria-hidden className="absolute inset-0 pointer-events-none" style={{
          background:
            "radial-gradient(ellipse 65% 62% at 50% 36%, rgba(12,18,60,0.45) 0%, transparent 62%)",
          filter: "blur(22px)",
        }} />
        ...
        <div aria-hidden className="absolute pointer-events-none" style={{
          ...
          width: "58%", height: "6%",
          background: "radial-gradient(ellipse at center, rgba(0,0,0,0.88) 0%, transparent 70%)",
          borderRadius: "50%",
          filter: "blur(26px)",
          opacity: 0.35,
        }} />
        ...
        {/* ── Image layers ──────────────────────────────────────────────
            layerA = current frame  (opacity = 1 - blend)
            layerB = next frame     (opacity = blend)
            Together they always sum to opacity 1 → smooth crossfade.
            No CSS transitions — RAF handles every update at 60fps.
        ──────────────────────────────────────────────────────────── */}
        <div
          ref={imgContainer}
          className="absolute inset-0"
          style={{
            ...
            filter: [
              "drop-shadow(0 32px 48px rgba(0,0,0,0.96))",
              "drop-shadow(0 0 20px rgba(0,12,70,0.08))",
            ].join(" "),
          }}
        >
