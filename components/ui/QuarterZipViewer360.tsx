...
/* ─── 4-frame sequence — front, right side, back, left side ─── */
const FRAMES = [
  "/products/quarter-zip-360/quarter-zip-000.png",
  "/products/quarter-zip-360/quarter-zip-090.png",
  "/products/quarter-zip-360/quarter-zip-180.png",
  "/products/quarter-zip-360/quarter-zip-270.png",
] as const;
...
export default function QuarterZipViewer360() {
