...
/* ─── 2 frames: front and back ─── */
const FRAMES = [
  "/products/beanie-360/beanie-000.png",   // Front
  "/products/beanie-360/beanie-180.png",   // Back
] as const;
...
export default function BeanieViewer360() {
    ...
    >
      ...
      >
        ...
        <div
          ...
          className="absolute"
          style={{
            /* Inset keeps the beanie at the same visual scale as the hoodie/polo */
