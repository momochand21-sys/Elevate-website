...
/* ─── 3 frames — front / right / back ─── */
const FRAMES = [
  "/products/padded-gilet-360/padded-gilet-000.png",
  "/products/padded-gilet-360/padded-gilet-090.png",
  "/products/padded-gilet-360/padded-gilet-180.png",
] as const;
...
export default function PaddedGiletViewer360() {
