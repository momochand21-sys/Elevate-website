...
/* ─── 6 frames from new source images ─── */
const FRAMES = [
  "/products/cap-360/cap-000.png",   // 0°   Front (full logo)
  "/products/cap-360/cap-090.png",   // 90°  Right side
  "/products/cap-360/cap-180.png",   // 180° Back
  "/products/cap-360/cap-270.png",   // 270° Left side
  "/products/cap-360/cap-315.png",   // 315° Left-side mirror
  "/products/cap-360/cap-045.png",   // 45°  Right-side mirror
] as const;
...
export default function CapViewer360() {
