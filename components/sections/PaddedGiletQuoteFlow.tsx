...
import { getUnitPrice } from "@/lib/product-pricing";
...
/* ─────────────────────────────────────────────────────────────────
   COMPONENT
───────────────────────────────────────────────────────────────── */
export default function PaddedGiletQuoteFlow({ productName }: { productName: string }) {
  ...
  const basePerUnit  = getUnitPrice("ELV-012", totalQty);
  ...
  const handleAddToBasket = () => {
    basket.addItem({
      productName,
      productCode: "ELV-012",
      productHref: "/products/gilets/padded-gilet",
      sizeQtys: { ...sizeQtys },
      totalQty,
      logo: logo!,
