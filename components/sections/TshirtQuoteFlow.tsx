...
/* ─────────────────────────────────────────────────────────────────
   COMPONENT
───────────────────────────────────────────────────────────────── */
export default function TshirtQuoteFlow({ productName }: { productName: string }) {
  ...
  const basePerUnit  = getUnitPrice("ELV-011", totalQty);
  ...
  const handleAddToBasket = () => {
    basket.addItem({
      productName,
      productCode: "ELV-011",
      productHref: "/products/t-shirts/workwear-tshirt",
      sizeQtys: { ...sizeQtys },
      totalQty,
      logo: logo!,
