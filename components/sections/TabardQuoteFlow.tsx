...
/* ─── Constants ─── */
// Tabard: one size, one position (Front Centre), same price for either method
...
const QTY_TIERS = PRODUCT_TIERS["ELV-010"];
...
/* ─────────────────────────────────────────────────────────────────
   COMPONENT
───────────────────────────────────────────────────────────────── */
export default function TabardQuoteFlow({ productName }: { productName: string }) {
  ...
  const handleAddToBasket = () => {
    ...
    basket.addItem({
      productName,
      productCode: "ELV-010",
      productHref: "/products/hospitality/tabard",
      qty: numQty,
      totalQty: numQty,
      logo: logo!,
