...
/* ─────────────────────────────────────────────────────────────────
   COMPONENT
───────────────────────────────────────────────────────────────── */
export default function HiVisVestQuoteFlow({ productName }: { productName: string }) {
  ...
  const basePerUnit  = getUnitPrice("ELV-008", totalQty);
  ...
  const handleAddToBasket = () => {
    basket.addItem({
      productName,
      productCode: "ELV-008",
      productHref: "/products/ppe/hi-vis-vest",
      sizeQtys: { ...sizeQtys },
      totalQty,
      logo: logo!,
