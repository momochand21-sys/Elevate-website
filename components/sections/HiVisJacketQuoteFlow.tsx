...
/* ─────────────────────────────────────────────────────────────────
   COMPONENT
───────────────────────────────────────────────────────────────── */
export default function HiVisJacketQuoteFlow({ productName }: { productName: string }) {
  ...
  const basePerUnit  = getUnitPrice("ELV-007", totalQty);
  ...
  const handleAddToBasket = () => {
    basket.addItem({
      productName,
      productCode: "ELV-007",
      productHref: "/products/ppe/hi-vis-jacket",
      sizeQtys: { ...sizeQtys },
      totalQty,
      logo: logo!,
